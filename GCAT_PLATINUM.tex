...
\subsection{La Constante Universal Efectiva $\kappa$}
...
\begin{quote}
\textit{``Considero muy posible que la física no pueda basarse en el concepto de campo, es decir, en estructuras continuas. En ese caso, no quedaría nada de todo mi castillo en el aire, incluida la teoría de la gravitación, y del resto de la física moderna.''} \\
--- \textbf{Albert Einstein}, Carta a Michele Besso (1954)
\end{quote}
