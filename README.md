...
[![Papers](https://img.shields.io/badge/Paper-Read_PDF-B31B1B?style=flat&logo=latex&logoColor=white)](https://github.com/NachoPeinador/Modular-Substrate-Theory/blob/main/Papers/TSM_paper.pdf)
...
## 🚨 The Current Paradigmatic Crisis
...
<p align="center">
  <img src="/Images/confinamiento_unificado.png" alt="Unified Confinement Map" width="85%">
  <br>
  <em>Figure 2: Conventional and exotic hadronic states align on the same Airy spectral series compressed by β = 3/4.</em>
</p>
...
3. **Modular Confinement Rule:**
   ...
   <img src="https://latex.codecogs.com/svg.latex?\sum_{i=1}^N%20r_i%20\equiv%200%20\pmod{6}" alt="∑ r_i ≡ 0 mod 6" width="150"/>
...
MST introduces **zero fitted free parameters**. All its fundamental constants (**R**<sub>fund</sub>, **β**, **κ**<sub>info</sub>) are derived analytically from first geometric and information-theoretic principles.
...
* [Discussions](https://github.com/NachoPeinador/Modular-Substrate-Theory/discussions) - Scientific Debate
* [Issues](https://github.com/NachoPeinador/Modular-Substrate-Theory/issues) - Technical Reports
* Twitter/X: [@JIPeinador](https://twitter.com/JIPeinador) - Updates

---

> *"Do not despise anyone; an atom casts a shadow."* > — **Pythagoras of Samos**
...
<b>Last Update:</b> January 2026 | <b>Status:</b> Research Complete | Made with ⚛️ & 🐍
