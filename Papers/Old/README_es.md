...
donde <img src="https://latex.codecogs.com/svg.latex?\hat{H}_0%20=%20\sum_{p\in\mathbb{P}}%20(\ln%20p)%20\hat{a}_p^\dagger%20\hat{a}_p" alt="Ĥ₀ = Σ_p (ln p) a_p† a_p" width="120"/> es el Hamiltoniano modular sobre los números primos.
...
- [Discussions](https://github.com/NachoPeinador/Modular-Substrate-Theory/discussions) - Debate científico
- [Issues](https://github.com/NachoPeinador/Modular-Substrate-Theory/issues) - Reportes técnicos
- Twitter/X: [@JIPeinador](https://twitter.com/JIPeinador) - Actualizaciones
